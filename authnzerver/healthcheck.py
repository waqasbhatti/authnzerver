...
class HealthCheckHandler(tornado.web.RequestHandler, RateLimitMixin):
    """
    ...
    async def get(self):
        ...
        backend_func = partial(database_health_check, config=self.config)
        ...
        all_workers_ok = (
            all(health_checks[key] for key in health_checks)
